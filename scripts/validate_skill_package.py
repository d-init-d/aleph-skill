...
REQUIRED_FILES = [
    ...
    "references/bundled-research-routing.md",
    ...
    "scripts/aleph/component_registry.py",
    "scripts/aleph/validator.py",
    "scripts/aleph/paths.py",
    "scripts/aleph/engine.py",
    "components/d-research/SKILL.md",
    "components/d-research/LICENSE",
    "components/d-research/package.json",
    "components/d-research/scripts/evidence_ledger.py",
