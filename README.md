...
Aleph pins D Research 3.5.0 (mandatory documentary and social branches, execution-backed Playwright exploration, hash-verified captures, source-lineage and correction tracking, policy-aware 37-column ledger import, strict lead/evidence separation, and machine-checkable interop contracts). Investigative operations remain workspace-confined and pass through the same locked gateway.
