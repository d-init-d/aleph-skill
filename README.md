...
Aleph pins D Research 3.4.0 (scope-bound investigative routing, policy-aware 37-column ledger import, strict lead/evidence separation, machine-checkable interop contract, config-driven API pagination, and explicit-intent HTTP methods). Investigative operations remain workspace-confined and pass through the same locked gateway.
