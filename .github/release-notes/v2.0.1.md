...
- Verifies the remote annotated tag object independently of `actions/checkout`, then binds its commit to both the checked-out source and the history of `main`.
